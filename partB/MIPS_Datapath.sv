...
module MIPS_Datapath (
    ...
    // --------------------------------------------------------
    // Branch decision
    // beq : Branch=1, BranchNotEqual=0 -> take when zero=1
    // bne : Branch=1, BranchNotEqual=1 -> take when zero=0
    // ----- This is the part which is modified to implement the instruction " BranchNotEqual " 
    assign pc_src = Branch & (BranchNotEqual ? ~zero : zero);
